	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (testuname.contentEquals(adminset.getString("uname")) && testpass.contentEquals(adminset.getString("pass")))
			{
				...
				out.println("<!DOCTYPE html><html><head><title>User Registry</title><style> body { text-align:left; font-family:serif; font-size:14; } h1 { text-align:center; } table { width:60%; }");
				...
				out.println("</table></body><footer><a href=\"/techexercise/Welcome.html\">Register an account.</a></footer></html>");
				out.close();
			}
			else
			{
				out.println("<!DOCTYPE html><html><head><title>Login Failure</title><style> body { text-align:left; font-family:Times New Roman; font-size:14; } h1 { text-align:left; font-family:Times New Roman; font-size:16; font-weight: bold; }");
				out.println("footer { text-align:center; font-family:Times New Roman; font-size:14; }</style></head>");
				...
				out.println("</body><footer><a href=\"/techexercise/Welcome.html\">Register an account.</a><a href=\"/techexercise/admin.html\">View registered users.</a></footer></html>");
				out.close();
			}
			
		} catch (IOException | SQLException | ClassNotFoundException e) {
			out.println("<!DOCTYPE html><html><head><title>Listing Failure</title><style> body { text-align:left; font-family:Times New Roman; font-size:14; } h1 { text-align:left; font-family:Times New Roman; font-size:16; font-weight: bold; }");
			out.println("footer { text-align:center; font-family:Times New Roman; font-size:14; }</style></head>");
